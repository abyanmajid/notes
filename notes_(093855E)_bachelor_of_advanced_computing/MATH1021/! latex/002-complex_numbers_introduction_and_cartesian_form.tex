...
\noindent\textbf{Properties of the modulus of complex numbers}
\begin{enumerate}
    \item $|zw|=|z|\times |w|$
    \item $|z\div w| = |z| \div |w|$, provided that $w\neq 0$
    \item $|z+w|\leq|z|+|w|$, known as "triangle inequality"
    \item $|z-w|\geq|z|-|w|$, known as "reverse triangle inequality"
\end{enumerate}
